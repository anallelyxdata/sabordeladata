  ...
  // append the svg object
    const svgPl = d3.select("#graficaPlatillos")
      ...
      svgPl.append("image")
          ...
          .attr('width', widthPl/6)
          .attr('height', widthPl/6)
          .attr("x", -widthPl/12)
          .attr("y", -heightPl/12);
    ...
    // Circulo 0
      // Add the circles
        let nodeTreePl = svgPl.append("g")
          .attr('class','gGrandePlatillos')
          .selectAll("circle")
          .data(data)
          .join("g")
            .attr("class", "nodePadrePlatillos")
            .attr('id', function(d) {
                return "nodePadrePlatillos"+d.Platillo
            })
            .append("circle")
...
return "pointer"
        ...
        // Texto interior de bubble grande
          d3.selectAll('.nodePadrePlatillos').append("text")
          ...
          d3.selectAll('.nodePadrePlatillos:nth-child(n+38) text')
