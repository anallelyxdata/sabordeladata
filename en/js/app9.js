...
$(window).on('scroll', function (e) {
  ...
  if(cuadroPostres){
    ...
    $('.texto-puntos').removeClass('textoBebidas');
      ...
      $('#puntos-prep-titulo').html('Desserts');

      $('#puntos-prep-p').html('What do buñuelos and muéganos have in common? Find out in this selection of traditional Mexican desserts where you can see the amount of ingredients used in each of them.');
    ...
    $('#puntos-prep-titulo').html('Drinks');

    $('#puntos-prep-p').html('Mexican gastronomy has many representative drinks that are prepared with more than 5 different ingredients, find out here what they are and how those same ingredients are used in different recipes.');
   ...
   $('.container-pl').addClass('graficaPlatillos');
    ...
    $('#puntos-prep-titulo').html('Main dishes');

    $('#puntos-prep-p').html('From the delicious chilaquiles to the traditional pozole, discover a selection of ingredients used in the making of more than 70 typical Mexican dishes.');
...
function esp() {
  window.open("https://x-data.mx/sabordeladata/","_self")
}
